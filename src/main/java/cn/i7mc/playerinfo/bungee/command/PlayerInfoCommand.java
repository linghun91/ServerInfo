...
public class PlayerInfoCommand extends Command {
    ...
    public PlayerInfoCommand(PlayerInfoBungee plugin) {
        super("playerinfobungee", "playerinfo.admin", "playerinfob", "pinfob");
        this.plugin = plugin;
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        if (args.length > 0) {
            ...
            switch (subCommand) {
                ...
                default:
                    sender.sendMessage(new TextComponent("§c未知的子命令. 使用 /playerinfobungee help 查看可用命令"));
                    break;
            }
        } else {
            showInfo(sender);
    ...
    private void showInfo(CommandSender sender) {
        ...
        sender.sendMessage(new TextComponent("§e使用 §f/playerinfobungee help §e查看帮助"));
    }
    ...
    private void showHelp(CommandSender sender) {
        ...
        sender.sendMessage(new TextComponent("§e/playerinfobungee §f- 显示插件信息"));
        sender.sendMessage(new TextComponent("§e/playerinfobungee reload §f- 重新加载配置"));
        sender.sendMessage(new TextComponent("§e/playerinfobungee servers §f- 显示已注册的服务器"));
        sender.sendMessage(new TextComponent("§e/playerinfobungee help §f- 显示此帮助信息"));
    }
} 